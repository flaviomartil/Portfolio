    ...
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <div class="social-links mt-3 text-center">
          <a href="http://fb.com/flaviomartil" target="_blank" class="facebook"><i class="bx bxl-facebook"></i></a>
          <a href="https://www.instagram.com/flaviowmartil/" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://join.skype.com/invite/BpMXWSv29aeK" target="_blank" class="google-plus"><i class="bx bxl-skype"></i></a>
          <a href="https://www.linkedin.com/in/flavio-wormstall-martil-384aa2175/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li class="active" ><a href="#" class="back-to-tops"><i class="bx bx-home"></i> <span>Inicio</span></a></li>
  ...
  <main id="main">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Aniversário:</strong> {{$newDate}}</li>

                  <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> {{$model->website}}</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Telefone:</strong> {{$model->telefone}}</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Cidade:</strong> {{$model->cidade_atual}}, Brasil</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Idade:</strong> {{$model->idade}}</li>
                  <li><i class="icofont-rounded-right"></i> <strong>E-mail:</strong> {{$model->email}}</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Freelance:</strong> {{$model->freelance_status}}</li>
                </ul>
              </div>
            </div>
            <p>
                <ul><li><i class="icofont-rounded-right"></i> <strong>Competências comportamentais: </strong>
                    <li><i class="icofont-rounded-right"></i>Forte relacionamento interpessoal, automotivado</li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="resume-item">
            ...
            <p>Faculdade que estou fazendo até o momento, me formo em 06/2021, pretendo iniciar gestão de projetos.</p>
          </div>
        </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <ul>
                <li>Desenvolvimento e manutenção de sistemas em Php/Laravel, C# (Intranet,CRM,E-commerce)</li>
                ...
                <li>ERP Protheus: experiência com rotinas, como de importação de clientes e pedidos, gestão de
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-{{$categoria->nome_categoria}}">{{$categoria->nome_categoria}}</li>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-{{$projeto->nome_categoria}}">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="{{url($projeto->imagem)}}"  data-gall="portfolioGallery" class="venobox" title="{{$projeto->descricao}}"><i class="bx bx-plus"></i></a>
                <a href="{{$projeto->link}}" title="Mais detalhes"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contato</h2>
          <p>Aqui você consegue me mandar um e-mail diretamente para mim, a respeito de freelance, vagas, fique a vontade</p>
        </div>
        ...
        <div class="row" data-aos="fade-in">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              ...
              <iframe src="https://maps.google.com/maps?q=atilio%20capello%20400&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen></iframe>
            </div>
            ...
            <form action="/sendEmail" method="post" role="form" class="php-email-form">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="name" class="form-control" id="name" data-rule="minlen:4" data-msg="Por favor digite pelo menos 4 palavras" />
                  <div class="validate"></div>
                </div>
                <div class="form-group col-md-6">
                  <label for="name">Seu e-mail</label>
                  <input type="email" class="form-control" name="email" id="email" data-rule="email" data-msg="Por favor insira um e-mail valido" />
                  <div class="validate"></div>
                </div>
              </div>
              <div class="form-group">
                <label for="name">Assunto</label>
                <input type="text" class="form-control" name="subject" id="subject" data-rule="minlen:4" data-msg="Por favor insira um assunto" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
                <label for="name">Mensagem</label>
                <textarea class="form-control" name="message" rows="10" data-rule="required" data-msg="Por favor escreva para mim"></textarea>
                <div class="validate"></div>
              </div>
              <div class="mb-3">
